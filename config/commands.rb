...
#    load "origen/commands/compile.rb"
  if Origen.app.stats.changed_files == 0 &&
    ...
    puts
    platforms = %w(j750 j750_literals j750_hpt ultraflex ultraflex_literals v93k v93k_multiport v93k_enable_flow v93k_disable_flow v93k_limits_file v93k_global v93k_smt8 v93k_flowgrouping v93k_disable_test_loop_increment/) # put here the various platforms used in examples/program_generator.rb
    reflist_command = ''
