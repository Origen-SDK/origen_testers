...
class UFLEX_PatCompiler
  ...
  def compile
    # puts 'UltraFLEX Pattern Compiler - fake version' 
  ...
  def file_contents(options = {})
    ...
    contents = 'generated by UltraFLEX Pattern Compiler - fake version' 
    options[:log] ? 'Log file ' + contents : 'PAT file ' + contents
  end
end

if __FILE__ == $0
  apc = UFLEX_PatCompiler.new
  apc.parse_args(ARGV)
  apc.compile
end
