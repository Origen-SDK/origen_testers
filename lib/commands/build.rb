...
The generated files can be tracked and diff-checked by RGen in the usual way.

Usage: rgen testers:build MANIFEST [options]
  EOT
...
if options[:new]
  template = "#{RGen.root!}/templates/manifest/#{$tester.name}.yaml.erb"
